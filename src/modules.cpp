...
ModuleSet create_all_mods(){
  ...
  ret.insert({"D_30",                2,  2,  4,   22.5,   100,  1000,   -1.2,   -4,   0,    -3,    12.5,  0,   0,   0});
  ret.insert({"NK_25",               2,  2,  4,   30,     100,  1500,   -1.3,   -4,   0,    -6.4,  18,    0,   0,   0});
  ret.insert({"D_30S",               2,  2,  4,   18.6,   100,  1000,   -0.2,   -4,   0,    -4,    21,    0,   0,   0});
  ret.insert({"RD_59",               4,  4,  16,  300.7,  400,  2000,   -2,     -8,   0,    -7,    45,    0,   0,   0});
  ret.insert({"RD_51",               4,  4,  16,  214.5,  400,  2000,   -1,     -8,   0,    -7,    65,    0,   0,   0});
  ...
  ret.insert({"ak_725",              2,  2,  4,   51.1,   100,  1500,   -0.75,  -6,   0,    0,     0,     -1,  2,   2.8});
  ret.insert({"ak_100",              2,  2,  4,   51.1,   100,  2000,   -1,     -6,   0,    0,     0,     -1,  2,   8});
  ret.insert({"d_80",                2,  2,  4,   51.1,   100,  4000,   -1,     -6,   0,    0,     0,     -1,  2,   8});
  ret.insert({"mk_1_180",            2,  2,  4,   81.2,   100,  4000,   -1.8,   -12,  0,    0,     0,     -2,  4,   13.66});
  ret.insert({"mk_2_180",            2,  2,  4,   81.2,   100,  6000,   -2.4,   -24,  0,    0,     0,     -4,  8,   16.4});
  ret.insert({"mk_6_180",            4,  4,  16,  409.2,  200,  24000,  -6,     -50,  0,    0,     0,     -8,  16,  70.28});
  ret.insert({"a_220",               2,  2,  4,   51.1,   100,  4000,   -3,     -5,   0,    0,     0,     -4,  8,   27});
  ret.insert({"mgu_61",              2,  2,  4,   93.2,   40,   200,    6.1,    -5,   0,    0,     0,     0,   0,   0});
  ret.insert({"mgu_28",              2,  1,  2,   43.4,   80,   150,    2.8,    -2,   0,    0,     0,     0,   0,   0});
  ...
  ret.insert({"FAB_1000",            2,  1,  2,   37.3,   100,  200,    0,      0,    0,    0,     0,     0,   1,   0});
  ...
  ret.insert({"LA_29",               3,  1,  3,   39.1,   100,  2000,   0,      -15,  0,    0,     0,     -1,  0,   0});
  ret.insert({"T_7",                 4,  2,  8,   107.8,  100,  2500,   0,      -15,  0,    0,     0,     -1,  0,   0});
  ret.insert({"MR_700",              4,  3,  12,  197.8,  100,  10000,  -6,     -2,   0,    0,     0,     0,   0,   0});
  ret.insert({"MR_500",              1,  2,  2,   14.4,   100,  4000,   -2,     -4,   0,    0,     0,     0,   0,   0});
  ret.insert({"MP_404",              2,  3,  6,   44.2,   100,  4000,   -2,     -1,   0,    0,     0,     0,   0,   0});
  ret.insert({"MP_21",               1,  1,  1,   8.5,    100,  2000,   -2,     -2,   0,    0,     0,     0,   0,   0});
  ret.insert({"MR_12",               2,  2,  4,   189.6,  0,    3000,   -2,     -1,   0,    0,     0,     0,   0,   0});
  ret.insert({"MR_2M",               1,  1,  1,   7.5,    0,    1000,   -1,     -2,   0,    0,     0,     0,   0,   0});
  ret.insert({"IRS_1",               2,  2,  4,   12.9,   100,  2000,   -1,     -1,   0,    0,     0,     0,   0,   0});
  ret.insert({"Jammer",              2,  1,  2,   23.3,   30,   2000,   -1,     -1,   0,    0,     0,     0,   0,   0});
  ret.insert({"ASO_75Flares",        1,  1,  1,   4.2,    40,   800,    0,      0,    0,    0,     0,     0,   0,   0});
  ret.insert({"Palash_1",            1,  1,  1,   4.2,    100,  1500,   0,      0,    0,    0,     0,     0,   0,   0});
